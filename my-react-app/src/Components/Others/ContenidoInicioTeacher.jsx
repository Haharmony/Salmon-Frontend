...
import ContenedorMateriasTeacher from "./ContenedorMateriasMaestro";
...
const ContenidoInicioT = ({ redireccionC, a_titulo, a_contenido, b_titulo, b_contenido}) => {
    return (
        <div className="contenido-inicio">
            <div className="contenedor-izquierdo">
                <ContenedorDesplegable titulo={a_titulo} contenido={a_contenido} />
                <ContenedorDesplegable titulo={'Mis Cursos'} contenido={<ContenedorMateriasTeacher redireccionB={redireccionC} />} />
...
export default ContenidoInicioT